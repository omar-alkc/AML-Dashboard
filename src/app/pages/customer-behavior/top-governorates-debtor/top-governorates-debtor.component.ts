...
@Component({
  selector: 'ngx-top-governorates-debtor',
  templateUrl: './top-governorates-debtor.component.html',
  styleUrls: ['./top-governorates-debtor.component.scss'],
})
export class TopGovernoratesDebtorComponent implements OnInit, OnChanges, OnDestroy {
  ...
  loadData() {
    ...
    const topGovernorates = this.behaviorService.getTopGovernorates(filters, 'debtor', this.metric);

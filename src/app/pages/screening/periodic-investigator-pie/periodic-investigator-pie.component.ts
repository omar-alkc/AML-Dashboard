...
@Component({
  selector: 'ngx-periodic-investigator-pie',
  templateUrl: './periodic-investigator-pie.component.html',
  styleUrls: ['./periodic-investigator-pie.component.scss'],
})
export class PeriodicInvestigatorPieComponent implements OnInit, OnChanges, OnDestroy {

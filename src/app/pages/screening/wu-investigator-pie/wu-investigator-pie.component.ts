...
@Component({
  selector: 'ngx-wu-investigator-pie',
  templateUrl: './wu-investigator-pie.component.html',
  styleUrls: ['./wu-investigator-pie.component.scss'],
})
export class WuInvestigatorPieComponent implements OnInit, OnChanges, OnDestroy {
  ...
  loadData() {
    this.loading = true;
    console.log('WU Investigator Pie - Loading chart data with dateRange:', this.dateRange);
    ...
    console.log('WU Investigator Pie - Investigator data received:', this.investigatorData);
